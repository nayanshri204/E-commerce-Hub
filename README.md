...
| Service   | Status | URL |
|----------|--------|-----|
| Frontend | 🟢 Live | [Vercel](https://e-commerce-hub-omega.vercel.app/) |
| Backend  | 🟢 Live | [Render](https://e-commerce-hub-6f2p.onrender.com/) |
| GitHub   | 📦 Repo | [Source Code](https://github.com/nayanshri204/E-commerce-Hub.git) |
